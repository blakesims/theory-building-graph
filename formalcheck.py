...
def evaluate_authority(pattern, trace):
    ...
    return result(outcome,witnesses=witnesses,diagnostics=diagnostics,checked_events=checked,scope='supplied finite trace only; may does not imply liveness')
