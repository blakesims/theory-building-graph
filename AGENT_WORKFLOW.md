...
`python3 replay.py fixtures/design-session/failed-attempt.json --compact` replays
...
`python3 session_evaluation.py prepare OUTPUT_DIRECTORY` creates equivalent
